...
logo = '\n|.  .dBBBBP   dBP dBP    dBBBP  dBBBBb  dBBBP  dBBBP  dBP dBP dBP dBP    dBP    dBBBP dBBBBBb
  BP                             dBP               d8P.dBP                              dBP
  `BBBBb  dBP dBP    dBBP   dBP dBP dBP    dBBP   dBBBBP  dBP dBP    dBP    dBBP    dBBBBK 
     dBP dBP dBP    dBP    dBP dBP dBP    dBP    dBP BB  dBP dBP    dBP    dBP     dBP  BB 
dBBBBP' dBP dBBBBP dBBBBP dBP dBP dBBBBP dBBBBP dBP dBP dBP dBBBBP dBBBBP dBBBBP  dBP  dB' 
                                                                                           '
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : GOOD BOY'
    print 'FACEBOOK : https://m.me/silencekiller404
    print 'GITHUB     : github.com/silencekiller404/killer'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
